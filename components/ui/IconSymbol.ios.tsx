...
const SF_SYMBOL_MAPPING: Record<string, string[]> = {
  'handshake': ['person.2', 'person.2.fill', 'group', 'group.fill', 'hand.raised', 'hand.raised.fill'],
  ...
  'speaker.wave.2.fill': ['speaker.wave.2.fill', 'speaker.3.fill', 'speaker.fill'],
...
export function IconSymbol({
  ...
  const symbolNames = SF_SYMBOL_MAPPING[name] || [name];
