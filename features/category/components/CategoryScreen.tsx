  ...
  return (
    <BendedRoad imageSource={categoryImage}>
      <View style={styles.container}>
        ...
        <Stack.Screen
          options={{ title: category?.text ?? 'فهرست اشعار' }}
        />
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          {poems.map((poem) => {
            ...
            return (
              <Pressable
                key={poem.id}
                onPress={() => handlePoemPress(poem.id)}
              >
                <ThemedView
                  style={[
                    styles.poemItem,
                ...
                >
                  <ThemedText style={styles.poemText}>
                    {poem.title}
                  </ThemedText>
                </ThemedView>
              </Pressable>
        ...
        {category?.text !== 'آغاز کتاب' && (
          <Pressable
            style={[
              styles.playButton,
              !isScenarioAvailable && styles.disabledButton,
            ]}
